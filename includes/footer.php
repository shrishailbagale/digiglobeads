    ...
    <div id="contact" class="card border-0" style="background-color:#edeff0;">
...
<div class="bg-blue py-4">
            <div class="row px-3">
                <small class="ml-4 ml-sm-5 mb-2">Copyright &copy; 2019. All rights reserved. | Designed by <a href="https://instagram.com/shrishail_bagale"> Shrishail Bagale</a></small>
